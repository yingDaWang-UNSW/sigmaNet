...
def args():
    ...
    parser.add_argument('--epoch', dest='epoch', type=str2int, default=350, help='# of epoch')

    parser.add_argument('--batch_size', dest='batch_size', type=str2int, default=64, help='# images in batch')
    parser.add_argument('--iterNum', dest='iterNum', type=str2int, default=1e6, help='# iterations per epoch') # not used right now
    ...
    parser.add_argument('--print_freq', dest='print_freq', type=str2int, default=5, help='print the validation images every X epochs')
    ...
    parser.add_argument('--cycleDiscLoss', dest='cycleDiscLoss', type=str, default='LS', help='LS, SC, RelSC')
    parser.add_argument('--srPixelwiseLoss', dest='srPixelwiseLoss', type=str, default='L1', help='L1, L2')
    parser.add_argument('--srDiscLoss', dest='srDiscLoss', type=str, default='SC', help='LS, SC, RelSC')
    # loss coefficients # use this when needed, for now just hardcode it.
